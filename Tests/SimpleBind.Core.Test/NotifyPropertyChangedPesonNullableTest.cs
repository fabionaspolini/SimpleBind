...
{
    [TestFixture]
    public class NotifyPropertyChangedPesonNullableTest
    {
        private BindContainer<Person> _container;
        private Person _sourcePerson = new Person();
        private PersonNullable _destPerson;
        ...
        private void CreateBinds(BindOrientarion orientarion)
        {
            ...
            _destPerson = new PersonNullable();
            ...
            {
                var lBinded = (BindedItem<Person, PersonNullable>) lItem;
                switch (orientarion)
                {
